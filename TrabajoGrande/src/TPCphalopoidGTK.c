...
#define GLADE_FILE_PATH "/home/lp1-2023/eclipse-workspace/TPCphalpoid/src/Tpfinal2.glade"
...

{
	...
	g_signal_connect(tablero_opciones, "clicked", G_CALLBACK(MOSTRAR_OPCIONES),NULL);
